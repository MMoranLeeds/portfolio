...
export const personalDetailsStore: Module<any, any> = {
    ...
    state: {
        ...
        introduction: "An experienced Lead Product Designer and Front-end Developer with 10+ years of extensive experience. </br></br>Working to create immersive User Interfaces I am well versed in using industry standard design software alongside up and coming Front-end technologies.</br></br>With a focus on developing responsive accessible sites I enjoy a hands on approach; from initial concepts and prototyping through to the development stage",
